...
describe('complex mapping', () => {
    const mockEvent = {
        ...
        authentication: {
            methods: [{name: 'pwd', timestamp: '2024-01-14T23:10:37.313Z'}],
            riskAssessment: {
                assessments: {
                    ImpossibleTravel: {code: 'location_history_not_found', confidence: 'high'},
                    NewDevice: {code: 'no_device_history', confidence: 'low'},
                    PhoneNumber: {code: 'phone_number_not_provided', confidence: 'neutral'},
        ...
        configuration: {},
        client: {client_id: 'VJIEWAptlFWokl2pRC2ptswic1jCGoEC', name: 'JWT.io', metadata: {}},
        request: {
            ip: '125.168.130.208',
            method: 'GET',
            query: {
    ...
    it('should do complex mapping', () => {
        ...
        const expectedUser = {
            _id: '79b1bf64cc40096ecc8d79172ff4e845',
            ...
            user_id: 'auth0|64aba27a81421100b34f2203',
            multifactor: ['guardian'],
            multifactor_last_modified: '2023-12-15T02:52:27.100Z',
            last_password_reset: '2023-12-15T03:20:33.206Z',
            global_client_id: 'indMoL7Aya109w09tV5Ei4gdTf1DmKL1',
            app_metadata: {crm_customer_id: 1234},
            crm_customer_id: 1234,
            persistent: {}
        };
        ...
        const expectedContext = {
            ...
            accessToken: {},
            idToken: {},
            authentication: {methods: [{name: 'pwd', timestamp: 1705273837313}]},
            locale: 'en',
            riskAssessment: {
                confidence: 'high',
                version: '1',
                assessments: {
                    UntrustedIP: {confidence: 'high', code: 'not_found_on_deny_list'},
                    NewDevice: {confidence: 'low', code: 'no_device_history'},
                    ImpossibleTravel: {confidence: 'high', code: 'location_history_not_found'},
                    PhoneNumber: {confidence: 'neutral', code: 'phone_number_not_provided'}
                }
            },
            sessionID: '7wHSq2a_0n83qWJ3R-l1M5_Vu3Bm6cEo',
            auth0SessionId: '7wHSq2a_0n83qWJ3R-l1M5_Vu3Bm6cEo',
            request: {
        ...
        wrapper.execute([mockRule], {event: mockEvent, api: {}});

        expect(mockRule).toBeCalledWith(expectedUser, expectedContext);
    });
